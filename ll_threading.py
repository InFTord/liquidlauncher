        ...
        while self.running:
            ...
            if self.snitch:
                ...
                try:
                    ...
                    res = requests.post(self.snitch_dest.rstrip("/") + "/liquidms/snitch", headers=http_headers,
                                        files=snitch_csv_obj)  # Pass CSV to Snitch API
                    res.raise_for_status()
                    self.update_snitchmsg_sig.emit(
                        'Successfully snitched {} to {}.  Thank you.'.format(self.snitch_src, self.snitch_dest))
                except Exception as e:
                    print('Snitch error: {}\n'.format(e))
